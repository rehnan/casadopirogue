    ...
    public function get_user() {
     ...
     public function get_user_permissions() {
        if ( $this->session ) {
            try {
                ...
                $user_permissions = $request->getGraphObject()->asArray();
                // Return data
     ...
     public function get_user_email() {
        if ( $this->session ) {
            try {
                 // Get users permissions list
                $request = (new FacebookRequest($this->session, 'GET', '/me?fields=email'))->execute();
                $user_email = $request->getGraphObject()->asArray();
                // Return data
